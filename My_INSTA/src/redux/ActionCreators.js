...
import { SET_IS_EMAIL_COMFRIMED } from "../constants/constants";
import { SET_IS_PHONE_COMFRIMED } from "../constants/constants";
...
export const setIsEmailConfirmedAction = (payload) => ({type: SET_IS_EMAIL_COMFRIMED, payload})
export const setIsPhoneConformedAction = (payload) => ({type: SET_IS_PHONE_COMFRIMED, payload})
